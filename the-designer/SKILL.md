...
Everything lives in `.the-designer/<YYYYMMDD-HHMM>/` in the working directory (keep it out of
commits; add `.the-designer/` to `.gitignore` if the project uses git and it is missing):
